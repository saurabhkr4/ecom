...
const Cart = () => {
    ...
    const loadData = async() =>{
        const response = await axios.get(`http://localhost:5000/getcart/item/${customer_id}`);
                        ...
                        return(
                            <tr key={item.order_id}>
                                ...
                                <td>
                                    ...
                                    <div>
                                    <button className='btn btn-danger mx-1' onClick={()=>handleClick(item.order_id)}>Delete</button>
                                    </div>
